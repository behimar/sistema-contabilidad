...
@section('content')
    ...
    <div class="section white">
        <div class="row container">
            ...
            <p class="grey-text text-darken-3 lighten-3">ContaWeb es un sistema de contabilidad creado para agilizar el proceso contable</p>
        </div>
    </div>
    <div class="parallax-container">
    ...
    <div class="section white">
        <div class="row container">
            <h2 class="header">Informacion del sistema</h2>
            <p>contenido aki!!</p>
